    ...
    <?php include 'php_page/Header.php' ?>
        <div class="main-history">
            <div class="container">
                ...
                <a href="Les Pourquoi de l'Histoire.php">En voir plus...</a>
            </div>
                </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="Les Pourquoi de l'Histoire 2.php">En voir plus...</a>
                </div>
            </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="Les Pourquoi de l'Histoire 3.php">En voir plus...</a>
                </div>
            </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="Les Pourquoi de l'Histoire 4.php">En voir plus...</a>
                </div>
            </div>
            </div>

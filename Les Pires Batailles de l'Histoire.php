...
<div class="main-history">
    ...
    <div class="booklist d-flex flex-wrap text-center">
        ...
        <img src="../Assets/Image/Les Pires Batailles de l'Histoire.jpg" width="70%" >
        <h4>Informations complémentaires </h4>
        <ul>
            <ol>Broché : 320 pages</ol>
            <ol>Editeur : Robert Laffont</ol>
        ...
        <div class="booktext col-lg-8 col_md_12">
            <p>
            <h2>Les Pires Batailles de l'Histoire</h2>
            <br>Dans l'esprit qui a fait le succès de son site Nota Bene, Benjamin Brillaud, mêlant sérieux des informations et humour, s'attaque ici aux quinze pires batailles de l'histoire mondiale, de l'Antiquité à nos jours.
            ...
            (non, ceci n'est pas du plagiat, mais un hommage)
            Aujourd'hui, nous allons nous pencher sur l'ouvrage de Benjamin Brillaud, Nota Bene - Les Pires Batailles de l'Histoire.
            À l'instar de nombreux collègues YouTubeurs, Bruce Benamran (Prenez le temps d'e-penser), David Louapre de Science étonnante (Mais qui a attrapé le bison de Higgs ?) ou Patrick Baud (Axolot) pour ne citer qu'eux, l'ami Bénabarbe comme il se faisait appeler à ses débuts, s'est lancé, après plusieurs années de beau succès sur Internet, dans l'aventure papier (comme quoi ces deux média sont complémentaires).
            Que ce soit sur sa chaîne ou dans ce livre, l'objectif de l'auteur est bien sûr de transmettre sa passion de l'Histoire mais surtout de proposer une nouvelle façon d'aborder cette science, trop souvent perçue comme froide, désincarnée et emplie d'une surabondance de dates et de noms. Dans Nota Bone, le vidéaste nous raconte des épisodes historiques, fait la part belle aux anecdotes, emploie un ton et une écriture simples et imagés ainsi qu'un langage moderne et compréhensible par tous.
            Dans cette même démarche, chaque chapitre du livre est contient une illustration d'Arcady Picardi qui ne colle pas forcément à la réalité mais ouvre une nouvelle porte au le lecteur pour s'imprégner de l'ambiance de la bataille racontée.
            Même volonté pour la partie « fiction » (distinguée par l'utilisation de caractères en itallqiue) présente aussi dans chaque chapitre mettant en scène des personnages réels ou inventés pour l'occasion sans pour autant trop s'éloigner des faits historiques. Toutefois, cette partie fonctionne pas très bien car ça semble artificielle et a du mal à s'imbriquer dans le reste du contenu.
            Par contre, clore chaque chapitre par une partie « Pendant ce temps-là dans le monde… » est une excellente idée. Il est toujours très important de remplacer les choses dans leur contexte et de voir ce qu'il se passe ailleurs au même moment car si ça peut paraître lointain et anecdotique aujourd'hui, cela peut avoir des conséquences et nous impacter dans le futur. En effet, qui pouvait penser qu'au moment où Saladin reprenait Jérusalem aux croisés, un chef de clan unifiait les tribus dans un coin de l'Asie devenant plus tard Gengis Khan et fondant le plus grand empire que le monde ait connu, reliant d'un seul bloc l'océan Pacifique à la mer Méditerranée : l'Empire Mongol
            Pour sa première tentative, Benjamin Brillaud nous offre un très bon ouvrage de vulgarisation, facile et agréable à lire, bien construit et dressant un panorama très large (-500 à 1961) de l'Histoire de l'Humanité.
            </p>

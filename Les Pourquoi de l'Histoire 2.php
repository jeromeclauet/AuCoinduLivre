...
<div class="main-history">
    ...
    <div class="booklist d-flex flex-wrap text-center">
        ...
        <ul>
            <ol>Broché : 304 pages</ol>
            <ol>Editeur : Albin Michel</ol>
            <ol>Date de Sortie : 27 Mai 2015</ol>
        ...
        <div class="booktext col-lg-8 col_md_12">
            ...
            Toujours écrit par Stéphane Bern, ce deuxième volume des pourquoi de l’Histoire garde la même recette qui pour moi a fait le succès du premier volume, c’est-à-dire expliquer au lecteur en une voire deux pages la réponse à une question donnée.
            Comme par exemple, pourquoi le symbole de la République française se nomme « Marianne » ou alors pourquoi l’hymne polonais est-il le seul a honoré Napoléon Bonaparte ? Comme d’habitude, la réponse se trouve à l’intérieur du livre.
            Je fais le même constat que pour le premier tome, je ne suis toujours pas fan de l’Histoire de manière générale mais je dois dire que la construction du livre permet de ne pas décrocher et pouvoir passer à une autre histoire rapidement.

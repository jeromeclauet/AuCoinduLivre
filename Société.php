    ...
    <?php include 'php_page/Header.php' ?>
        <div class="main-society">
            <div class="container">
                ...
                <a href="Carnets de Guerre.php">En voir plus...</a>
            </div>
                </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="Crépuscule des Titans.php">En voir plus...</a>
                </div>
            </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="La France divisée contre elle-même.php">En voir plus...</a>
                </div>
            </div>
            </div>
            <div class="container">
            <div class="booklist d-flex flex-wrap text-center">
                ...
                <a href="Le Feu et La Fureur.php">En voir plus...</a>
                </div>
            </div>
            </div>
